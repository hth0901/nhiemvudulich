...
/***/ (function (module, exports, __webpack_require__) {
            ...
            Tree.createLiEle = function (node, closed) {
                ...
                if (node.icon) {
                    if (node.type == "point") {
                        var imgwraper = document.createElement('img');
                        imgwraper.classList.add('treejs-icon');
                        imgwraper.src = node.icon;
                        li.appendChild(imgwraper);
                    } else if (node.type == "polyline") {
                        const ns = 'http://www.w3.org/2000/svg';

                        const spinner = document.createElementNS(ns, 'svg');
                        spinner.setAttribute('width', '40');
                        spinner.setAttribute('height', '4');

                        const spinnerG = document.createElementNS(ns, 'g');
                        spinnerG.setAttribute('transform', 'matrix(0.9090909361839294,0,0,0.9090909361839294,1.8181818723678589,-1.6363636255264282)');

                        const spinnerPath = document.createElementNS(ns, 'path');
                        spinnerPath.setAttribute('fill', 'none');
                        spinnerPath.setAttribute('fill-rule', 'evenodd');
                        spinnerPath.setAttribute('stroke', node.icon);
                        spinnerPath.setAttribute('stroke-width', '4');
                        spinnerPath.setAttribute('stroke-linecap', 'round');
                        spinnerPath.setAttribute('stroke-linejoin', 'round');
                        spinnerPath.setAttribute('stroke-dasharray', 'none');
                        spinnerPath.setAttribute('stroke-miterlimit', '4');
                        spinnerPath.setAttribute('d', 'M 0 4 L 40 4');

                        spinnerG.appendChild(spinnerPath);
                        spinner.appendChild(spinnerG);
                        ...
                        const spinnerG = document.createElementNS(ns, 'g');
                        spinnerG.setAttribute('transform', 'matrix(1.125,0,0,1.125,12,12)');

                        const spinnerPath = document.createElementNS(ns, 'path');
                        spinnerPath.setAttribute('fill', node.icon);
                        spinnerPath.setAttribute('fill-rule', 'evenodd');
                        spinnerPath.setAttribute('stroke', 'rgba(0, 0, 0, 1)');
                        spinnerPath.setAttribute('stroke-width', '1.3333333333333333');
                        spinnerPath.setAttribute('stroke-linecap', 'round');
                        spinnerPath.setAttribute('stroke-linejoin', 'round');
                        if (node.loai == "MuongCap") {
                            spinnerPath.setAttribute('stroke-dasharray', '4,5.333333333333333');
                        } else {
                            spinnerPath.setAttribute('stroke-dasharray', '0');
                        }
                        spinnerPath.setAttribute('stroke-miterlimit', '4');
                        spinnerPath.setAttribute('d', 'M -10,-10 L 10,0 L 10,10 L -10,10 L -10,-10 Z');

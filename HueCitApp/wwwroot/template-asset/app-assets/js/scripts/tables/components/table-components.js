  ...
  $(".colors li").on("click", function () {
    ...
    if (!self.hasClass("active")) {
      ...
      if (skin.hasClass("skin-square")) {
        ...
        checkbox === undefined &&
          ((checkbox = "icheckbox_square-red"), (radio = "iradio_square-red"));
      }
      ...
      if (skin.hasClass("skin-flat")) {
        ...
        checkbox === undefined &&
          ((checkbox = "icheckbox_flat-green"), (radio = "iradio_flat-green"));
      }
      ...
      if (skin.hasClass("skin-line")) {
        ...
        checkbox === undefined &&
          ((checkbox = "icheckbox_line-blue"), (radio = "iradio_line-blue"));
      }

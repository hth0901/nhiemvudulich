  ...
  header_navbar.hasClass("navbar-semi-light") && (semiLight = !0),
    ...
    $("#static-layout").on("click", function () {
      $(this).prop("checked") === !0
        ? (header_navbar.hasClass("navbar-static-top") ||
          ...
          footer.hasClass("footer-static") || footer.addClass("footer-static"),
          horz_layout === !0 &&
    ...
    $("#brand-center").on("click", function () {
      header_navbar.hasClass("navbar-brand-center")
        ...
        : (1 == semiLight && header_navbar.removeClass("navbar-semi-light"),
          1 == semiDark && header_navbar.removeClass("navbar-semi-dark"),

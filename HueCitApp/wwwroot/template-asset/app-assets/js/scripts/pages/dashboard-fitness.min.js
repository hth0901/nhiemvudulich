...
!(function (window, document, $) {
  ...
  $(".icheck-activity").iCheck({
    ...
    $("#fitness-stats").sparkline(
      [
        5, 6, 7, 8, 9, 10, 13, 15, 13, 12, 10, 9, 10, 12, 15, 18, 16, 14, 12,
        10, 8, 5,
      ],
      {
        type: "bar",
    ...
    $(".knob").knob({
      ...
      draw: function () {
        var ele = this.$,
          ...
          fontSize = parseInt(ele.css("font-size"), 10),
          ...
          series: [
            {
              ...
              itemStyle: {
                normal: {
                  label: { show: !0, textStyle: { color: "#333333" } },
                  labelLine: { show: !0, lineStyle: { color: "#333333" } },
                },
                emphasis: {
                  label: {
                    show: !0,
  ...
  var rtl = !1;
  "rtl" == $("html").data("textdirection") && (rtl = !0),
    rtl === !0 && $(".tweet-slider").attr("dir", "rtl"),
    rtl === !0 && $(".fb-post-slider").attr("dir", "rtl"),

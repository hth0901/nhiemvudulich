          ...
          markPoint: {
            data: [
              // Vertical Axis, Default
              {
                ...
                symbol: "emptyCircle",
                itemStyle: {
                  normal: { color: "#dc143c", label: { position: "top" } },
                },
              },
              {
                type: "min",
                ...
                symbol: "emptyCircle",
                itemStyle: {
                  normal: { color: "#dc143c", label: { position: "bottom" } },
                },
              },
              // Horizontal Axis
              {
                ...
                symbol: "emptyCircle",
                itemStyle: {
                  normal: { color: "#1e90ff", label: { position: "right" } },
                },
              },
              {
                type: "min",
                ...
                symbol: "emptyCircle",
                itemStyle: {
                  normal: { color: "#1e90ff", label: { position: "left" } },
                },
              },
            ],
          },
